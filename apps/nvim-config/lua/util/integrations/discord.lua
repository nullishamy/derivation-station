require('presence'):setup({
  ...
  blacklist = require('config').discord.blacklist or {}, -- A list of strings or Lua patterns that disable Rich Presence if the current file name, path, or workspace matches
